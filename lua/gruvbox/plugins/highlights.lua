...
local plugins = lush(function()
	return {
		-- LspDiagnosticsError({ base.GruvboxAqua }),
		-- LspDiagnosticsWarning({ base.GruvboxAqua }),
		-- LspDiagnosticsInformation({ base.GruvboxAqua }),
		-- LspDiagnosticsHint({ base.GruvboxAqua }),

		-- NvimTree
		NvimTreeFolderIcon({ base.GruvboxBlueBold }),
		NvimTreeIndentMarker({ base.GruvboxBlueBold }),
		NvimTreeVertSplit({ base.GruvboxBg0 }),
		NvimTreeFolderName({ base.GruvboxBlueBold }),
		NvimTreeOpenedFolderName({ base.GruvboxBlueBold }),
		NvimTreeImageFile({ base.GruvboxPurpleBold }),
		NvimTreeGitStaged({ base.GruvboxGreenBold }),
		NvimTreeGitNew({ base.GruvboxGreenBold }),
		NvimTreeGitDirty({ base.GruvboxOrangeBold }),
		NvimTreeGitDeleted({ base.GruvboxRedBold }),
		NvimTreeGitMerge({ base.GruvboxAquaBold }),
		NvimTreeGitRenamed({ base.GruvboxAquaBold }),
		NvimTreeSymlink({ base.GruvboxAquaBold }),
		NvimTreeRootFolder({ base.GruvboxPurpleBold }),
		NvimTreeExecFile({ base.GruvboxRed }),
